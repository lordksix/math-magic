const KEYPAD = [
  ...
  {
    category: 'number', value: '/', row: 1, column: 3, id: 12,
  },
  {
    category: 'operation', value: '-', row: 3, column: 3, id: 13,
  },
  {
    category: 'number', value: '=', row: 5, column: 2, id: 14,
  },
  {
  ...
  {
    category: 'operation', value: 'AC', row: 1, column: 0, id: 17,
  },
  {
    category: 'operation', value: '.', row: 5, column: 1, id: 18,
  },
];
